...
| `pricePerDay` | Number | 2,000–200,000 ₦ (optional) |
| `pricePerWeek` | Number | 10,000–1,000,000 ₦ (optional) |
| `pricePerMonth` | Number | 30,000–3,000,000 ₦ (optional) |
| `availableBookingTypes[]` | Text (repeatable) | hourly, daily, weekly, monthly (optional) |
...
```bash
curl -X POST http://localhost:5002/api/v1/spaces \
...
- `pricePerDay`: 2,000–200,000 ₦, optional
- `pricePerWeek`: 10,000–1,000,000 ₦, optional
- `pricePerMonth`: 30,000–3,000,000 ₦, optional
- `availableBookingTypes[]`: hourly, daily, weekly, monthly (optional)
...
- **Endpoint:** `GET /api/v1/spaces/my/spaces`
...
- **Endpoint:** `DELETE /api/v1/spaces/:id`
