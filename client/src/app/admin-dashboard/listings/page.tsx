...
function ListingRow({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[minmax(260px,1fr)_160px_160px_120px_120px] gap-4 items-center">
      {/* Space Details */}
      <div className="flex items-center gap-3 min-w-[260px]">
        <div className="w-[97px] h-[86px] rounded-lg overflow-hidden shrink-0">
          <Image src={image} alt={name} width={97} height={86} className="object-cover w-full h-full" />
        </div>
        <div className="flex flex-col gap-1">
      ...
      {/* Host */}
      <div className="flex flex-col gap-1">
        <span className="text-[16px] font-medium text-[#121212]">{hostName}</span>
        <span className="text-[14px] text-[#686767]">{hostEmail}</span>
      </div>

      {/* Submission Date */}
      <div className="text-[16px] text-[#686767]">{submittedDate}</div>
